...
| **Total** | **85** | ~~**18 distinct types**~~ → **38 after session 7**, **39 after session 8** (`AboutWindow`), **46 counted 2026-09-09** |
...
>
> `Button` and `Label` counts barely moved (72→67, and 58 unchanged — this line said 55), and that is expected: the
